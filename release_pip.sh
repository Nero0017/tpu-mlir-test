...
# find ./bin/ -maxdepth 1 -type f -exec sh -c 'patchelf --set-rpath "\$ORIGIN/../lib/:\$ORIGIN/../../tpu_mlir_dependence/lib/third_party/" "$0"' {} \;
# find ./python/ -maxdepth 1 -type f -exec sh -c 'patchelf --force-rpath --set-rpath "\$ORIGIN/../lib/:\$ORIGIN/../../tpu_mlir_dependence/lib/third_party/" "$0"' {} \;
# patchelf --set-rpath '$ORIGIN/../../../lib/:$ORIGIN/../../../../tpu_mlir_dependence/lib/third_party/' ./python/mlir/_mlir_libs/libTPUMLIRPythonCAPI.so.18git
# patchelf --set-rpath '$ORIGIN/../../../lib/:$ORIGIN/../../../../tpu_mlir_dependence/lib/third_party/:$ORIGIN/' ./python/mlir/_mlir_libs/_mlir.cpython-310-x86_64-linux-gnu.so
# patchelf --set-rpath '$ORIGIN/../../../lib/:$ORIGIN/../../../../tpu_mlir_dependence/lib/third_party/:$ORIGIN/' ./python/mlir/_mlir_libs/_mlirDialectsQuant.cpython-310-x86_64-linux-gnu.so
# patchelf --set-rpath '$ORIGIN/../../../lib/:$ORIGIN/../../../../tpu_mlir_dependence/lib/third_party/:$ORIGIN/' ./python/mlir/_mlir_libs/_mlirRegisterEverything.cpython-310-x86_64-linux-gnu.so
# popd
...
########################################## build tpu_mlir dependence package ##########################################
release_archive="./tpu_mlir_dependence"
mkdir -p ${release_archive}
cp ${PROJECT_ROOT}/release_tools/dependence/__init__.py ${release_archive}
cp ${PROJECT_ROOT}/release_tools/dependence/{setup.py,MANIFEST.in} ${PROJECT_ROOT}

# collect_caffe_dependence
# cp -rf ${INSTALL_PATH}/lib ${release_archive}
...
# # set rpath
# pushd ${release_archive}
# find ./lib/ -maxdepth 1 -type f -exec sh -c 'patchelf --force-rpath --set-rpath "\$ORIGIN/./:\$ORIGIN/./../../tpu_mlir_dependence/lib/third_party/" "$0"' {} \;
# find ./lib/third_party/ -maxdepth 1 -type f -exec sh -c 'patchelf --force-rpath --set-rpath "\$ORIGIN/../../../tpu_mlir/lib/:\$ORIGIN/./" "$0"' {} \;
# popd
